...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-ice-900 text-ice-100 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-ice-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-xs text-ice-400">
            ...
            <div className="flex space-x-6 text-xs">
              <a href="/privacy" className="text-ice-400 hover:text-ice-100 transition-colors">Privacy Policy</a>
              <a href="/terms" className="text-ice-400 hover:text-ice-100 transition-colors">Terms of Service</a>
              <a href="/cookies" className="text-ice-400 hover:text-ice-100 transition-colors">Cookie Policy</a>
            </div>
          </div>
          
          <div className="mt-4 text-xs text-ice-500 text-center">
            <p>Blockchain transactions verified on Avalanche C-Chain • Gas fees under $0.01 • 100% transparent fund allocation</p>
          </div>
        </div>
      </div>
    </footer>
