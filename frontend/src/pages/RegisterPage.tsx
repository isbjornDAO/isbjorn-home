...
const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 py-4 overflow-hidden bg-gradient-to-br from-white via-ice-50 to-arctic-50">
      {/* Background Image */}
      <div
      ...
      >
          ...
          <div className="text-center mb-4">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-arctic-400 to-arctic-600 rounded-2xl mb-3 shadow-xl"
            >
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="flex flex-col items-center justify-center p-3 border-2 border-gray-200 rounded-xl hover:border-arctic-400 hover:bg-arctic-50 transition-all group"
              >
