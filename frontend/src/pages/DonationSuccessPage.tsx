    ...
    <div className="min-h-screen bg-gradient-to-br from-ice-50 to-arctic-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-arctic-900 mb-2">
            🎉 Donation Successful!
          </h1>
          <p className="text-lg text-arctic-600">
            Your donation has been processed and is 100% IRD compliant
          </p>
        </div>

        {/* Processing Time Banner */}
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 mb-8 text-white text-center">
          <div className="flex items-center justify-center space-x-4">
            <ClockIcon className="h-8 w-8" />
            <div>
              <div className="text-3xl font-bold">{formatTime(processingTime)}</div>
              <p className="text-green-100">Total Processing Time</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-ice-200 p-8 mb-8">
          <h2 className="text-xl font-semibold text-arctic-900 mb-6">Donation Details</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-sm font-medium text-arctic-500 uppercase tracking-wide">Receipt Number</h3>
              <p className="text-lg font-semibold text-arctic-900 mt-1">{donation.receiptNumber}</p>
            </div>
            
            <div>
              <h3 className="text-sm font-medium text-arctic-500 uppercase tracking-wide">Donation ID</h3>
              <p className="text-lg font-mono text-arctic-700 mt-1">{donation.donationId}</p>
            </div>
          </div>

          <div className="mt-6 pt-6 border-t border-ice-200">
            <h3 className="text-sm font-medium text-arctic-500 uppercase tracking-wide mb-4">
              Processing Summary
            </h3>
            <div className="space-y-3">
              <div className="flex items-center">
                <CheckCircleIcon className="h-5 w-5 text-green-500 mr-3" />
                <span className="text-arctic-700">Payment processed successfully</span>
              </div>
              <div className="flex items-center">
                <CheckCircleIcon className="h-5 w-5 text-green-500 mr-3" />
                <span className="text-arctic-700">IRD-compliant receipt generated</span>
              </div>
              <div className="flex items-center">
                ...
                <span className="text-arctic-700">
              ...
              <div className="flex items-center">
                <CheckCircleIcon className="h-5 w-5 text-green-500 mr-3" />
                <span className="text-arctic-700">Receipt archived for 7 years (IRD compliant)</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            ...
            className="flex-1 bg-arctic-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-arctic-700 transition-colors flex items-center justify-center"
          >
          ...
          <button
            ...
            className="flex-1 bg-white border-2 border-arctic-600 text-arctic-600 py-3 px-6 rounded-lg font-semibold hover:bg-arctic-50 transition-colors"
          >
          ...
          <button
            onClick={() => navigate('/')}
            className="flex-1 bg-ice-100 text-arctic-700 py-3 px-6 rounded-lg font-semibold hover:bg-ice-200 transition-colors"
          >
            Back to Home
          </button>
        </div>
        ...
        {donation.blockchain && (
          <div className="mt-6 bg-purple-50 border border-purple-200 rounded-xl p-6">
            ...
            <p className="text-sm font-mono text-purple-600 bg-purple-100 p-2 rounded">
        ...
        {/* Footer */}
        <div className="mt-12 text-center text-arctic-500">
