...
import "./IcePondERC20.sol";
import "./SafeMath.sol";
import "./UQ112x112.sol";
import "./IERC20.sol";
import "./IIcePondFactory.sol";
import "./Math.sol";
import "./IIsbjornCallee.sol";
...
contract IcePond is IcePondERC20 {
    ...
    modifier lock() {
        require(unlocked == 1, "Isbjorn: LOCKED");
        unlocked = 0;
        _;
        unlocked = 1;
    }
    ...
    function mint(address to) external lock returns (uint256 liquidity) {
        ...
        if (_totalSupply == 0) {
            address migrator = IIcePondFactory(factory).migrator();
        ...
        require(liquidity > 0, "Isbjorn: INSUFFICIENT_LIQUIDITY_MINTED");
        _mint(to, liquidity);
    ...
    function burn(
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "Isbjorn: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "Isbjorn: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "Isbjorn: INSUFFICIENT_LIQUIDITY"
        );
        ...
        require(
            ...
            "Isbjorn: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
