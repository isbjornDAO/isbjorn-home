...
export interface IIcePondInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface IIcePond extends BaseContract {
  connect(runner?: ContractRunner | null): IIcePond;
  waitForDeployment(): Promise<this>;

  interface: IIcePondInterface;
