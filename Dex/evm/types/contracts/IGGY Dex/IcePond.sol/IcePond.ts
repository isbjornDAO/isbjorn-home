...
export interface IcePondInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface IcePond extends BaseContract {
  connect(runner?: ContractRunner | null): IcePond;
  waitForDeployment(): Promise<this>;

  interface: IcePondInterface;
