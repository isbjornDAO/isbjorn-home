...
export interface IIsbjornRouter02Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WAVAX"
      | "addLiquidity"
...
export interface IIsbjornRouter02 extends BaseContract {
  connect(runner?: ContractRunner | null): IIsbjornRouter02;
  waitForDeployment(): Promise<this>;

  interface: IIsbjornRouter02Interface;
