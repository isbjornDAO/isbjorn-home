...
export interface IJoe2RouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addLiquidity"
...
export interface IJoe2Router extends BaseContract {
  connect(runner?: ContractRunner | null): IJoe2Router;
  waitForDeployment(): Promise<this>;

  interface: IJoe2RouterInterface;
