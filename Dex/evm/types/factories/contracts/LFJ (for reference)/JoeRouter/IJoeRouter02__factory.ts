...
} from "../../../../contracts/LFJ (for reference)/JoeRouter/IJoeRouter02";
...
export class IJoeRouter02__factory {
  ...
  static createInterface(): IJoeRouter02Interface {
    return new Interface(_abi) as IJoeRouter02Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IJoeRouter02 {
    return new Contract(address, _abi, runner) as unknown as IJoeRouter02;
  }
}
