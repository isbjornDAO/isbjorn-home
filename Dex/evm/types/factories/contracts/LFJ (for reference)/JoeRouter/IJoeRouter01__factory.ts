...
} from "../../../../contracts/LFJ (for reference)/JoeRouter/IJoeRouter01";
...
export class IJoeRouter01__factory {
  ...
  static createInterface(): IJoeRouter01Interface {
    return new Interface(_abi) as IJoeRouter01Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IJoeRouter01 {
    return new Contract(address, _abi, runner) as unknown as IJoeRouter01;
  }
}
