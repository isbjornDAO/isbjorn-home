...
import type {
  IIsbjornRouter02,
  IIsbjornRouter02Interface,
} from "../../../contracts/IGGY Dex/IIsbjornRouter02";
...
export class IIsbjornRouter02__factory {
  static readonly abi = _abi;
  static createInterface(): IIsbjornRouter02Interface {
    return new Interface(_abi) as IIsbjornRouter02Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IIsbjornRouter02 {
    return new Contract(address, _abi, runner) as unknown as IIsbjornRouter02;
  }
}
